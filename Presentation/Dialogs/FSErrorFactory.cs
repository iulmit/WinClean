...
public static class FSErrorFactory
{
    ...
    /// <summary>Sets a <see cref="TaskDialogPage"/> or a subclass with the data of a filesystem error.</summary>
    /// <param name="page">The page to modify.</param>
    /// <inheritdoc cref="MakeFSError{T}(Exception, FSVerb, FileSystemInfo)" path="/param"/>
    /// <returns>
    /// A reference to <paramref name="page"/> with its <see cref="TaskDialogPage.Icon"/> and <see cref="TaskDialogPage.Text"/>
    /// properties modified.
    /// </returns>
