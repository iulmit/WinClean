...
public class ScriptExecutor
{
    ...
    public async Task ExecuteScriptsAsync(IList<IScript> scripts, TimeSpan timeout, Func<string, bool> promptKillOnHung, Func<Exception, FileSystemInfo, Operational.FSVerb, bool> promptRetryOnFSError, uint promptLimit)
    {
